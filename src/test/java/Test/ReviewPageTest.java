...
public class ReviewPageTest extends Base{
	...
	@Test
	public void ReviewPageTest() throws InterruptedException {

		// clicking on the packages link in nav bar
		LandingPage landingPage = new LandingPage(driver);
		Thread.sleep(3000);
		landingPage.Review().click();
		log.debug("Clicked on Review page in nav bar");
		Thread.sleep(2000);
	}
	...
	public void launching() throws IOException {
		...
		log = LogManager.getLogger(ReviewPageTest.class.getName());
		// opening the website
